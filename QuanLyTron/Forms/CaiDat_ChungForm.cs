...
using System.Drawing.Printing; // Thêm thư viện cho chức năng in
...
namespace QuanLyTron.Forms
{
    public class CaiDat_ChungForm : Form
    {
        ...
        private TextBox txtTenTram, txtChuTram, txtDiaDiem, txtSoDienThoai, txtCongSuat;
        ...
        public CaiDat_ChungForm()
        {
            ...
            btnCaiDatMayIn = new IconButton()
            {
                ...
                Font = btnFont,
                ForeColor = Color.White,
                BackColor = Color.FromArgb(231, 76, 60), // Màu đỏ cho nút cài đặt máy in
                FlatStyle = FlatStyle.Flat,
            ...
            btnCaiDatMayIn.FlatAppearance.BorderSize = 0;
        ...
        private void BtnCaiDatMayIn_Click(object sender, EventArgs e)
        {
            try
            {
                // Tạo và hiển thị hộp thoại cài đặt máy in
                ...
                {
                    // Lưu cài đặt máy in mặc định
                    printDocument.PrinterSettings = printDialog.PrinterSettings;
                    
                    // Hiển thị thông báo thành công
                    MessageBox.Show("Đã cài đặt máy in thành công!\nMáy in mặc định: " + printDocument.PrinterSettings.PrinterName, 
                                   "Cài đặt máy in", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("Lỗi khi cài đặt máy in: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
